...
namespace IdeaCenter
{
...

    {
        ...
        private const string StaticToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..28MqMjrkfFld5HY5uoO-Pr6szFo2xb1PXWYOdDhtKl4";
        private const string LoginEmail = "iliana_050@abv.com";
        ...
        [Order(1)]
        [Test]
        public void CreateIdea_WithRequiredFields()
        {
        ...
        public void GetAllIdeas_ShouldReturnListOfIdeas()
        {
            ...
            lastCreatedId = responseItems.LastOrDefault()?.Id;
        }
        [Order(3)]
        [Test]
        public void EditExistingIdea_ShouldReturnSucccess()
        {
            ...
            request.AddQueryParameter("ideaId", lastCreatedId);
